...
class HardpointedShip(x: Double, y: Double, width: Double, height: Double, velocity: Double, orientation: Entity.Orientation,
    ...
    : Ship(x, y, width, height, velocity, orientation, maxHealth, onDeath, onExpire, {ship -> hardpoint.weapon.fire(ship, hardpoint.x, hardpoint.y).forEach{spawnProjectile(it, hardpoint.weapon)}}, pilot) {
