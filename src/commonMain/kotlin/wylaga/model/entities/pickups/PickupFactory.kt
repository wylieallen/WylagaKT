...
class PickupFactory(private val onDisable: (Pickup, Cause) -> Unit, private val addToScore: (Int) -> Unit, private val weaponUpgrades: Array<Weapon>, private val spawnWingmen: (Ship) -> Unit) {
